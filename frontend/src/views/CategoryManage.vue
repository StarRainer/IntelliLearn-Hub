  ...
  <div class="category-manage-container">
    ...
    <el-dialog title="分类详情" v-model="viewDialogVisible" width="500px">
      <div class="category-detail" v-if="viewCategoryData">
		...
		<div class="detail-row"><span class="label">分类级别：</span><span class="value"><el-tag :type="viewCategoryData.parentId === 0 ? 'primary' : 'success'">{{ viewCategoryData.parentId === 0 ? '一级分类' : '二级分类' }}</el-tag></span></div>
